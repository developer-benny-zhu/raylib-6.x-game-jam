...
flags="-sEXPORTED_RUNTIME_METHODS=['HEAPF32'] -sUSE_GLFW=3 -sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=67108864 -g --shell-file source/main_web/index_template.html --preload-file assets"
